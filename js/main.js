(function () {
  ...
  var ES = {
    ...
    mq1: "Limpieza Residencial", mq2: "Limpieza Comercial", mq3: "Limpieza Profunda", mq4: "Mudanzas", mq5: "Post-Construcción", mq6: "Rentas Vacacionales",
    ...
    s1t: "Limpieza Residencial", s1d: "Mantenimiento regular para que tu hogar se mantenga fresco, ordenado y acogedor.",
    s1a: "Cocina y baños", s1b: "Polvo y superficies", s1c: "Aspirado y trapeado",
    ...
    s4t: "Mudanzas (Entrada / Salida)", s4d: "Entrega las llaves o instálate en tu nuevo hogar con cada rincón listo.",
    s4a: "Gabinetes y clósets", s4b: "Electrodomésticos por dentro y por fuera", s4c: "Listo para inspección",
    s5t: "Post-Construcción", s5d: "Eliminamos polvo y residuos tras remodelaciones para que disfrutes el resultado.",
    s5a: "Eliminación de polvo fino", s5b: "Ventanas y accesorios", s5c: "Repaso final de detalles",
    s6t: "Rentas Vacacionales", s6d: "Cambios rápidos y confiables para que cada huésped llegue a un espacio impecable.",
