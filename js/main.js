(function () {
  ...
  var ES = {
    ...
    p2t: "Recibe tu cotización", p2d: "Visitamos tu espacio y te damos el estimado.",
    ...
    rvLead: "Tu opinión nos ayuda a mejorar y ayuda a otras familias y negocios a elegir con confianza.",
    rvCount: "reseñas", rvCount1: "reseña", rvLoading: "Cargando reseñas…", rvEmptyT: "Sé el primero en dejar una reseña",
    rvEmptyD: "Cuéntanos cómo te fue con tu limpieza usando el formulario.",
    rvError: "No se pudieron cargar las reseñas en este momento. Inténtalo más tarde.",
    rfTitle: "Deja tu reseña", rfSub: "Comparte tu experiencia con otros clientes.",
    rfRating: "Tu calificación", rfText: "Tu reseña", rfTextPh: "¿Cómo fue tu experiencia con Smelling Clean?",
    rfError: "Por favor escribe tu nombre y una reseña de al menos 10 caracteres.",
    rfSendError: "No se pudo enviar tu reseña. Inténtalo de nuevo en un momento.",
    rfOkT: "¡Gracias por tu reseña!", rfOkD: "Ya fue publicada.", rfSend: "Enviar reseña",
    ...
    formTitle: "Solicita tu cotización gratis", formSub: "Visitamos tu espacio y te damos una cotización gratis.",
